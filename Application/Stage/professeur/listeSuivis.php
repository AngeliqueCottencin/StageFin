...
if(($_SESSION['role'] == "prof")||($_SESSION['role'] == "admin")) {
    ...
    <?php
        ...
        $listeStagesByProf = listeStage_ByLoginProf($_SESSION['login']);
        if (isset($_GET['eleve'])) {
            nePlusSuivre($_GET['eleve']);
        ...
        <div id="wrapper">
            ...
            <div id="main">
                ...
                <section id="intro" class="main">
                    <center><h2>Liste des élèves que vous suivez</h2></center></br>
                    <table>
                        <tr>
                            ...
                            <th><center>Ne plus suivre cet élève</center></th>
                        </tr>

                        <?php foreach ($listeStagesByProf as $element) { ?>
                            <tr>
                                ...
                                <td><center>
                                    <a href="infoTuteur.php?idTuteur=<?php echo $element->idTuteur ?>"><?php echo "M/Mme " . $element->nomTuteur ?></center></a>
                                </td>
                                <td><center><a href="listeSuivis.php?eleve=<?php echo $element->idUserEleve; ?>">Ne plus
                                        suivre</a></center></td>
                            </tr>
                        <?php } ?>
