...
?>
        ...
        <li><a href=./../aide.php>Aide</a></li>
            ...
            <section id="intro" class="main">
                <center><h2>Liste des élèves n'ayant pas de stage</h2></center>
            <table>
            <tr>
            ...
            <tr>
                <td><center><?php echo $eleve->nomEleve." ".$eleve->prenomEleve ?></center></td>
                <td><center><?php echo $eleve->classeEleve ?></center></td>
            </tr>
        <?php } ?>
        </table>
        </section>
